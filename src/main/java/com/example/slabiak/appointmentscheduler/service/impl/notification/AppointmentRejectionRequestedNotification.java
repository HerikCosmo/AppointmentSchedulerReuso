...
public class AppointmentRejectionRequestedNotification extends NotificationTemplate {
    private final Appointment appointment;

    public AppointmentRejectionRequestedNotification(Appointment appointment, NotificationService notificationService, EmailService emailService, boolean mailingEnabled) {
    ...
    protected String getMessage() {
        return appointment.getCustomer().getFirstName()
                ...
                + "rejected an appointment. Your approval is required";
    }
