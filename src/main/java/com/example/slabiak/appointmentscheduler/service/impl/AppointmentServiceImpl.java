...
//     public AppointmentServiceImpl(AppointmentRepository appointmentRepository, UserService userService, WorkService workService, ChatMessageRepository chatMessageRepository, NotificationService notificationService, JwtTokenServiceImpl jwtTokenService, ScheduleService scheduleService) {
...
//         availablePeroids = scheduleService.excludeAppointmentsFromTimePeroids(availablePeroids, providerAppointments);

//         availablePeroids = scheduleService.excludeAppointmentsFromTimePeroids(availablePeroids, customerAppointments);
//         return scheduleService.calculateAvailableHours(availablePeroids, workService.getWorkById(workId));
//     }
